...
public class HibernateRun {
    public static void main(String[] args) {
        ...
        try {
            ...
            Item item1 = create(new Item("Learn Hibernate", "Mikhail Pushkarev", new Timestamp(838365835L)), sf);
            System.out.println(item1);
            item1.setDescription("Roman Vlasov");
            update(item1, sf);
            System.out.println(item1);
            Item rsl1 = findById(item1.getId(), sf);
            System.out.println(rsl1);
            delete(rsl1.getId(), sf);
            List<Item> list1 = findAll(sf);
            for (Item it : list1) {
